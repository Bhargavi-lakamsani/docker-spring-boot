pipeline {
    ...
    stages {
        stage('Checkout') {
            steps {
                checkout scmGit(branches: [[name: '*/master']], extensions: [], userRemoteConfigs: [[url: 'https://github.com/Bhargavi-lakamsani/docker-spring-bhttps://github.com/Bhargavi-lakamsani/docker-spring-boot.git']])
            }
        }
